                ...
                {selectedAttributes.includes('cost_price') && (
                  <div className="w-40 flex-shrink-0">
                    <InputText
                      name="cost_price"
                      onChange={e =>
                        onAttributeChange(variant, 'cost_price', e.target.value)
                      }
                      leftComponent={
                        <div className="text-md text-sm text-gray-400">OMR</div>
                      }
                ...
                {selectedAttributes.includes('taxable') && (
                  <div className="w-40 flex-shrink-0">
                    <Checkbox
                      ...
                      onChange={e =>
                        onAttributeChange(variant, 'taxable', e.target.checked)
                      }
                    />
                  </div>
                )}
                ...
                {selectedAttributes.includes('tracked') && (
                  <div className="w-40 flex-shrink-0">
                    <Checkbox
                      ...
                      onChange={e =>
                        onAttributeChange(variant, 'tracked', e.target.checked)
                      }
                    />
                  </div>
                )}
